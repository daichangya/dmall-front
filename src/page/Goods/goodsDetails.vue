      ...
      <div class="banner">
        <div class="sku-custom-title">
          ...
          <h5>
            ...
            <div v-html="product.subTitle">{{ product.subTitle }}</div>
            <!--<span class="price">-->
        ...
        <!--</div>-->
        <div class="buy">
            <!--<el-row   v-for="(item,i) in links" :key="i">-->
              <!--<a @click="linkTo( item)" class="el-button" >{{i}}</a>-->
          <el-row   v-for="(item,i) in links" :key="i">
            &nbsp;&nbsp;
            <y-button :text="i" @btnClick="linkTo(item)"
              classStyle="main-btn"
